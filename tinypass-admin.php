					...
					<table class="form-table">
						...
						<tr valign="top">
							...
							<td>
								...
								<br>
								<span class="description"><strong>Note:</strong> The Sandbox environment is for testing the TinyPass experience.  When enabled, no actual payment will be processed.
							</td>
						</tr>
						<tr><td></td></tr>
						<tr><td></td></tr>
	...
	<div class="wrap">
		...
		<div class="postbox">
			...
			<div class="inside">
				...
				<div>
					<input class="button" type="button" hef="#" onclick="tinypass.showTinyPassPopup('tag');" value="Add Tag">
				</div>
...
<div class="inside">
	...
	<table class="wp-list-table widefat fixed media" style="width:800px">
		...
		<tr>
			...
			<td>
				<input id="tp_modify_button" class="button" type="button" hef="#" onclick="return tinypass.showTinyPassPopup('tag', <?php echo $term['term_id'] ?>);" value="Modify">
				<input id="tp_modify_button" class="button" type="button" hef="#" onclick="if(confirm('Are you sure you want to delete these TinyPass settings')) tinypass.deleteTagOption(<?php echo $term['term_id'] ?>);" value="Delete">
			</td>
