...
function tinypass_add_meta_boxes() {
	add_meta_box(
					...
					'<img src="http://www.tinypass.com/favicon.ico">&nbsp;' . __( 'TinyPass Post Options'),
					'tinypass_meta_box_display',
					'post',
					'side'
	);
	add_meta_box(
					'tinypass_post_options',
					'<img src="http://www.tinypass.com/favicon.ico">&nbsp;' . __( 'TinyPass Page Options'),
					'tinypass_meta_box_display',
					'page',
					'side'
	);
