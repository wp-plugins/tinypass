...
3. In your WordPress dashboard, go to TinyPass->Settings. Under Application IDs and Keys you will see four fields. 
  ...
  -- The first two fields are auto-generated by TinyPass and correspond to your ÒSandboxÓ environment. The Sandbox allows you to test the TinyPass experience and to see how TinyPass will appear to your audience without actually processing any payments.

  -- The second two fields are ÒLiveÓ and are meant to be used once you are ready to begin accepting payments. In order to begin accepting payments, enter the AID and secret key that were generated when you registered your application with TinyPass. Those values can be found in the "Applications" section of your publisher account at www.TinyPass.com.
